...
if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif" ) 
{
  ...
  $uploadOk = 0;
  header("refresh:.5;url=RequestServices.php");
}
...
$newfilename=$_POST['txtStype'];
$temp = explode(".", $_FILES["simage"]["name"]);
$newfilename = ($newfilename . '.' . end($temp));

  if (move_uploaded_file($_FILES["simage"]["tmp_name"],$target_dir .$newfilename)) 
  {

//########### WRITE INFORMATION IN requestservices TABLE  #################

$insertSQL="INSERT INTO requestservices values ('','".$_POST['cmbScategory']."','".$_POST['txtStype']."','".$target_dir .$newfilename."')";
...
echo "The file ". htmlspecialchars( basename( $_FILES["simage"]["name"])). " has been uploaded.";	
  } 
  else 
  {
