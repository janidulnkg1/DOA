...
//##################################################    IMAGE TRANSFER    ################################
$target_dir = "../IMAGES/farmerProducts/";
...
if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif" ) 
{
  ...
  $uploadOk = 0;
  header("refresh:.5;url=RequestfProducts.php");
}
...
$insertSQL="INSERT INTO farmerproducts values ('','".$_POST['cmbpcategory']."','".$_POST['txtptype']."','".$target_dir .$newfilename."')";
